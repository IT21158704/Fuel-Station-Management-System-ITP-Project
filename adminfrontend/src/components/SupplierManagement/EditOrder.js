                                ...
                                <div className="order">
                                    ...
                                    <form onSubmit={handleSubmit} >
                                        ...
                                        <div className="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <input type="text" id="inputState" className="form-control form-control-user"  name="amount" value={users.amount}
                                            onChange={handleChange}/>
                                        </div>
                                     ...
                                     <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                        <div className="col-sm-6 mb-3 mb-sm-0">
                                            <label htmlFor="date" className="col-sm-2 col-form-label">Diliveryate:</label>
                                            <input type="date"className="form-control form-control-user" id="date" name="deliverydate"  value={users.deliverydate}
                                                 onChange={handleChange}/>
                                        </div>
                                        ...
                                        <div className="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <input type="text" className="form-control form-control-user" id="amount" name="price" value={users.price}
                                            onChange={handleChange}/>
                                        </div>
                                        <br/>
